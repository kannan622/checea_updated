...
public class Adapter_card_listview_zonewise extends BaseAdapter {

    Context c;
    List<zone_model> players = null;
    // CustomFilter filter;
    ArrayList<offers_model> filterList;
    boolean isSet;


    private ArrayList<zone_model> arraylist;
    private int selectedPosition = 0;

    public Adapter_card_listview_zonewise(Context ctx, List<zone_model> players) {
        // TODO Auto-generated constructor stub

        this.c = ctx;
        this.players = players;

        this.arraylist = new ArrayList<zone_model>();
